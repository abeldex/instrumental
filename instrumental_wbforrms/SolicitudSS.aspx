<%@ Page Title="" Language="C#" MasterPageFile="~/flat.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="SolicitudSS.aspx.cs" Inherits="instrumental_wbforrms.SolicitudSS" %>
                  ...
                  <div class="col-lg-12">
                      ...
                      <section class="panel">
                          <header class="panel-heading">
                              <center><b>SOLICITUD DE EQUIPO PARA SERVICIO SOCIAL</b></center>
                          </header>
                          <div class="panel-body">
                               <!--DIV DEL FOLIO-->
        <div>
            <h4 style="color:#ff6a00">Numero Solicitud:   <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></h4>
                               ...
                               <form id="default" runat="server">
                                  ...
                                  <div class="col-md-3 col-xs-11">
                                      ...
                                      <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="12-02-2012"  class="input-append date dpYears">
                                          ...
                                          <input type="text" value="12-02-2012" size="16" class="form-control" runat="server" id="lblFecha">
                                              <span class="input-group-btn add-on">
                                                <button class="btn btn-warning" type="button"><i class="icon-calendar"></i></button>
                                              </span>
                                      </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                              &nbsp&nbsp&nbsp&nbsp<img alt="" width="40px" src="Content/themes/theme_up/css/images/1379011746_schedule.png" /> <asp:Button ID="btnTurno" runat="server" Text="Obtener Turno" CssClass="btn btn-shadow btn-warning" OnClick="btnTurno_Click"/>
                                          </div>
                                      </div>
                                  ...
                                  <fieldset title="Paso 2: MI BRIGADA" class="step" id="paso2" runat="server">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                              ...
                                              <asp:SqlDataSource ID="SqlDataSourceBrigada" runat="server" ConnectionString="<%$ ConnectionStrings:InstrumentalConnectionString %>" SelectCommand="SELECT * FROM [brigada] WHERE bri_tipo = 'SS'"></asp:SqlDataSource>
                                          </div>
                                      </div>
                                      <br /><br />
                                      <div class="form-group">
                    ...
                    <SelectParameters>
                        <asp:ControlParameter ControlID="cmbBrigada" Name="bri_codigo" PropertyName="SelectedValue" Type="Int32" />
                                      ...
                                      <div class="form-group">
                                          ...
                                          <asp:Button ID="btnSeleccionarFechayTurno" runat="server" Text="Atras" CssClass="btn btn-shadow btn-warning" OnClick="btnSeleccionarFechayTurno_Click" />
                                              
                                          <asp:Button ID="btnElegirPractica" runat="server" Text="Seleccionar Equipos" CssClass="btn btn-shadow btn-warning" OnClick="btnElegirPractica_Click"/>
                    ...
                    <SelectParameters>
                        <asp:ControlParameter ControlID="Label1" Name="codigo" PropertyName="Text" Type="Int32" DefaultValue="" />
                                        ...
                                        <div class="form-group">
                                          ...
                                          <asp:Button ID="btnCancelarSolicitud" runat="server" Text="Cancelar Solicitud" CssClass="btn btn-shadow btn-warning" OnClick="btnCancelarSolicitud_Click" />
                                              
                                          <asp:Button ID="btnEnviarSolicitud" runat="server" Text="Enviar Solicitud" CssClass="btn btn-shadow btn-warning" OnClick="btnEnviarSolicitud_Click"/>
